...
{
    private static void RenderSawSamples(
        int[] buffer,
        Voice voice,
    ...
    )
    {
        ...
        {
            RenderSawSamplesPitchAmplitudeLfo(
                buffer,
                voice,
                state,
                partialDelays,
    ...
    private static void RenderSawSamplesPitchLfo(
        int[] buffer,
        Voice voice,
        VoiceRenderState state,
        ReadOnlySpan<int> partialDelays,
    ...
    private static void RenderSawSamplesAmplitudeLfo(
        int[] buffer,
        Voice voice,
        VoiceRenderState state,
        ReadOnlySpan<int> partialDelays,
    ...
    private static void RenderSawSamplesPitchAmplitudeLfo(
        int[] buffer,
        Voice voice,
        VoiceRenderState state,
        ReadOnlySpan<int> partialDelays,
