...
{
    private static void RenderSineSamples(
        int[] buffer,
        Voice voice,
    ...
    )
    {
        ...
        {
            RenderSineSamplesPitchAmplitudeLfo(
                buffer,
                voice,
                state,
                partialDelays,
    ...
    private static void RenderSineSamplesPitchLfo(
        int[] buffer,
        Voice voice,
        VoiceRenderState state,
        ReadOnlySpan<int> partialDelays,
    ...
    private static void RenderSineSamplesAmplitudeLfo(
        int[] buffer,
        Voice voice,
        VoiceRenderState state,
        ReadOnlySpan<int> partialDelays,
    ...
    private static void RenderSineSamplesPitchAmplitudeLfo(
        int[] buffer,
        Voice voice,
        VoiceRenderState state,
        ReadOnlySpan<int> partialDelays,
