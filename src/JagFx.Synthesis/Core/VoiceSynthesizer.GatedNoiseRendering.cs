...
{
    private static void RenderGatedNoiseSamples(
        int[] buffer,
        Voice voice,
    ...
    )
    {
        ...
        {
            RenderGatedNoiseSamplesPitchAmplitudeLfo(
                buffer,
                voice,
                state,
                partialDelays,
        ...
        if (pitchLfoEnabled)
        {
            RenderGatedNoiseSamplesPitchLfo(
                buffer,
                voice,
                state,
                partialDelays,
        ...
        {
            RenderGatedNoiseSamplesAmplitudeLfo(
                buffer,
                voice,
                state,
                partialDelays,
    ...
    private static void RenderGatedNoiseSamplesPitchLfo(
        int[] buffer,
        Voice voice,
        VoiceRenderState state,
        ReadOnlySpan<int> partialDelays,
    ...
    private static void RenderGatedNoiseSamplesAmplitudeLfo(
        int[] buffer,
        Voice voice,
        VoiceRenderState state,
        ReadOnlySpan<int> partialDelays,
    ...
    private static void RenderGatedNoiseSamplesPitchAmplitudeLfo(
        int[] buffer,
        Voice voice,
        VoiceRenderState state,
        ReadOnlySpan<int> partialDelays,
