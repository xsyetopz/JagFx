...
export declare const waveforms: readonly Waveform[];
...
export declare function createSegment(
	duration: number,
	targetLevel: number,
): SegmentJson;

export declare function createEnvelope(
	envelope?: Partial<EnvelopeJson>,
): EnvelopeJson;

export declare function createLfo(
	rateEnvelope: EnvelopeJson,
	modulationDepth: EnvelopeJson,
): LfoJson;

export declare function createPartial(partial: PartialJson): PartialJson;

export declare function createEcho(echo?: Partial<EchoJson>): EchoJson;

export declare function createLoop(
	beginMs?: number,
	endMs?: number,
): LoopSegmentJson;

export declare function createVoice(voice: VoiceJson): VoiceJson;

export declare function createPatch(patch?: Partial<PatchJson>): PatchJson;

export declare function readPatchJson(path: string): Promise<PatchJson>;

export declare function writePatchJson(
	path: string,
	patch: PatchJson,
): Promise<void>;

export declare function synthToJson(
	inputPath: string,
	options?: SynthToJsonOptions,
): Promise<PatchJson>;

export declare function jsonToSynth(
	patchOrPath: PatchJson | string,
	outputPath: string,
	options?: CommandOptions,
): Promise<void>;

export declare function renderPatchToWav(
	patchOrPath: PatchJson | string,
	outputPath: string,
